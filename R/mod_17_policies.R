...
terms_of_use_content <- function() {
  HTML('
    <div class="policy">
      ...
      <p>All content, trademarks, and data on this website, including but not limited to software, databases, text, graphics, icons, hyperlinks, private information, designs, and agreements, are the property of or licensed to RTutor LLC and as such are protected from infringement by local and international legislation and treaties. All content, AI models, algorithms, and data used or generated by our Services are the property of RTutor LLC or its licensors and are protected by intellectual property laws. By using our Services, you agree that:
      <br><br>You retain ownership of the data you submit to the AI assistant.
      ...
      <p>To the fullest extent permitted by law, RTutor LLC shall not be liable for any indirect, incidental, special, consequential, or punitive damages arising from or related to your use of the Services, including but not limited to:<br><br>
      ...
      <br>In no event shall RTutor LLC nor its directors, employees, partners, or affiliates, be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from:<br>
      <br>Your use or inability to use the Services.<br>
...
privacy_policy_content <- function() {
  HTML('
    <div class="policy">
      ...
      To perform research and analysis aimed at improving the Services, or other products and technologies of RTutor LLC.<br>
      ...
      To protect against harm to the rights, property or safety of RTutor LLC, our users, yourself, or the public.<br>
      ...
      <p>RTutor LLC will use the information collected from you to pursue legitimate interests such as legal or regulatory compliance, security control, business operations, scientific research, or any other interest reasonably held as legitimate.</p>
      ...
      <p>In the event of any fraud, security threats, or incidents, we reserve the right to disclose your information without your consent for the purposes of maintaining security on our website and for our users and addressing fraud or security issues. We reserve the right to disclose your information without your consent for the purpose of protecting against harm to the rights, property, or safety of RTutor LLC, our users, yourself, or the public.<br></p>
      ...
      <p>You may be entitled under data protection laws to access and review personal information that RTutor LLC holds related to you. You may access, modify, or delete the information we collected by controlling the content that you share or upload at any time.<br><br>
      ...
      <p>Orditus.com is neither directed to nor structured to attract children under the age of 13 years. Accordingly, RTutor LLC does not intend to collect personal information from anyone it knows to be under 13 years of age. RTutor LLC will direct potential users under 13 years of age not to use the Services. If the Company learns that personal information of persons less than 13 years of age has been collected without verifiable parental consent, RTutor LLC will take the appropriate steps to delete this information.<br><br>
      To make such a request, please contact RTutor LLC at: <a href="mailto:ge@orditus.com?Subject=RTutor&cc=daniel.burkhalter@orditus.com,jenna@orditus.com">ge@orditus.com</a>.</p>
      <h2>9. Contact Us</h2>
