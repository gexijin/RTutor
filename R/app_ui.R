      ...
      tabPanel(
        ...
        sidebarLayout(
          sidebarPanel(
            ...
            br(),
            h5("Reset to Switch Datasets!"),
            h5("Unsure what to ask? Say 'Find data on Bridges' first. Look at it on the Data tab before asking."),
          ),
          ...
          mainPanel(
            ...
            conditionalPanel(
              ...
              conditionalPanel(
                ...
                uiOutput("plot_ui"),
                leaflet::leafletOutput("leaflet_map", width = "100%", height = "600px"),
                fluidRow(
                  column(
                    width = 5,
                    checkboxInput(
