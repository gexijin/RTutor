            ...
            conditionalPanel(
              ...
              fluidRow(
                ...
                column(
                  ...
                  h4("Nov. 9: Switching to the new GPT-4 Turbo model!  Nov. 1: (v0.98.2): Just upload your data, RTutor can generate ",
                    a(
              ...
              tags$ul(
                ...
                tags$li(
                  ...
                  Previous questions and code chunks in the same session become the context for the response to your new request.
                  ...
                  To analyze a new, unrelated dataset, click the Reset button first."
                ),
                tags$li(
                ...
                tags$li(
                  ...
                  If you explain the background of the data and the  
                  the columns, you can ask general questions like emailing a clueless statistician."
                ),
                tags$li(
