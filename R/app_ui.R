            ...
            conditionalPanel(
              ...
              tags$ul(
                ...
                tags$li(
                  ...
                  With that, previous questions and code chunks become the context of your new request.
                  For example, you can simple say \"Change background color to white.\" to change the 
                  background color of the plot generated by the previous chunk.
                  You can also process your data step by step in successive code chunks. 
                  Go back to any previous chunk and continue from there."
                ),
                tags$li(
                  "Prepare and clean your data in Excel first! Name columns properly. 
                  ChatGPT do tries to guess the meaning of column names, even abbrievated.
