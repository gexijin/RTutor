...
mod_10_eda_serv <- function(id, selected_dataset_name, use_python,
  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$no_data_message <- renderUI({
      ...
      tagList(div(style =
        "color:#0009B7;font-size:18px;font-weight:bold;text-align:center;margin-top:20px;",
        "To view the exploratory data analysis (EDA), please choose a dataset."
      ))
    })
